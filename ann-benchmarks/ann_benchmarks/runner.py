...
function"""
    ...
    try:
        ...
        if hasattr(algo, "set_index_cache"):
            algo.set_index_cache(index_dir, index_mode, dataset_name)
        ...
        for pos, query_arguments in enumerate(query_argument_groups, 1):
            ...
            store_results(dataset_name, count, definition, query_arguments, descriptor, results, batch, output_dir)
    finally:
        algo.done()
